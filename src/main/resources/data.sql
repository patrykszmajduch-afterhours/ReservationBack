...
values (1,'Miedzy nami trupami','test info','Spektakl','test location',TO_DATE('17/08/2020', 'DD/MM/YYYY'),'jpg');
insert into Event_Details(event_Id,title,info,type_event,location,date_Of,img_Ext)
values (2,'Dobrze się kłamie','test info','Spektakl','test location',TO_DATE('17/12/2020', 'DD/MM/YYYY'),'jpg');
insert into Event_Details(event_Id,title,info,type_event,location,date_Of,img_Ext)
