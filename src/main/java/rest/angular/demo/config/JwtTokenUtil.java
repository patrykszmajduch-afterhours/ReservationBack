...
//TODO:tu zrobić admin true bądź nie
		return Jwts.builder().setClaims(claims).setSubject(subject).claim("UserType", authorities).setIssuedAt(new Date(System.currentTimeMillis()))
